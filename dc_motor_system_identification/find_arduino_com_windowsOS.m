function com_name = find_arduino_com_windowsOS()
% Find_arduino_com_windowsOS identifies Serial COM devices on Windows systems by friendly name
...
% the function finally search the list for the name Arduino and return its
% com name 
devices = [];
...
for i =1: size(devices,1)
     k = strfind(devices{i,1},'Arduino');
     if k==1
        com_name = strcat("COM",num2str(devices{i,2}));
     else
        com_name="no_found_arduino";
     end
end